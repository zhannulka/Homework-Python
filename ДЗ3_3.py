...
if n == 1:
	print('За это слово вы получаете', sum([a for i in word for a, b in eng.items() if i in b]), 'очков')
elif n == 0:
	print('За это слово вы получаете', sum([a for i in word for a, b in rus.items() if i in b]), 'очков')
